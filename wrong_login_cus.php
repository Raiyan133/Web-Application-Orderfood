...
<div class="main">
    ...
    <div class="col-md-4 col-sm-3"></div>
        ...
        <h2>Log in</h2>
        <font color="red"><h6>*Log in failed prease try again*</h6></font>
          <form method="post" action="check_login_customer.php" >  
              <div class="row">
                  <div class="col-sm-10">
              ...
              <div class="row">
                  <div class="col-sm-10">
                      <div class="form-group">
                          Password: <input type="password" name="password" id="password" value="" class="form-control" />
                      </div>          
                  </div>
              </div>
            <input class="btn btn-info" type="submit" name="submit" value="log in" />  
            <a href='http://localhost/food/registercustomer.php'>&nbsp;&nbsp;&nbsp;Create new Account</a> 
          </form > 
