    ...
    <div class="container tim-container">
        ...
        <div id="images">
                <div class="col-md-6 col-sm-6">
                  <a href="http://localhost/food/logincustomer.php">
                    <div class="text-center">
                    <h4>CUSTOMER</h4>
                    <img src="assets/img/cus.png" alt="Circle Image" class="img-circle">
                    </div>
                  </a>
                </div>
        </div>
                <div class="col-md-6 col-sm-6">
                  <a href="http://localhost/food/loginseller.php">
                    <div class="text-center">
                    <h4>SELLER</h4>
                    <img src="assets/img/seller.png" alt="Circle Image" class="img-circle">
                    </div>
                   </a>
                </div>
            </div>
