...
$_SESSION['orderListID'] = array();
    $_SESSION['qty'] = array();
    $_SESSION['price'] = array();

    foreach ($_SESSION["key_order"] as $key => $value) {
        if ($_POST[$value] != 0) {
            array_push($_SESSION['orderListID'],$value );
            array_push($_SESSION['qty'],$_POST[$value] );
        }
    }
...
<button class="btn cyan waves-effect waves-light right" type="submit">
            <A HREF="javascript:history.back()">Edit Order</A> 
             </button>
        ...
        <form action="save_order.php" method="POST">
          <div class="space-30"></div>
                <div class="tim-title text-center">
                    <h3>Select NO. Table</h3>
                </div>
                <div class="row tim-row" >
                    <div class="col-md-6 col-sm-6 ">
        
            <div class="form-group">
                <input type="radio" name="t" value="1" required>&nbsp;Table NO.1
            </div>
            <div class="form-group">
                <input type="radio" name="t" value="2">&nbsp;Table NO.2
            </div>
            <div class="form-group">
                <input type="radio" name="t" value="3">&nbsp;Table NO.3
            </div>
            <div class="form-group">
                <input type="radio" name="t" value="4">&nbsp;Table NO.4
            </div>
            <div class="form-group">
                <input type="radio" name="t" value="5">&nbsp;Table NO.5
            </div>
            <div class="form-group">
                <input type="radio" name="t" value="6">&nbsp;Table NO.6
            </div>
            <div class="form-group">
                <input type="radio" name="t" value="7">&nbsp;Table NO.7
            </div>
            <div class="form-group">
                <input type="radio" name="t" value="8">&nbsp;Table NO.8
            </div>
            <div class="form-group">
                <input type="radio" name="t" value="9">&nbsp;Table NO.9
            </div>
            <div class="form-group">
                <input type="radio" name="t" value="10">&nbsp;Table NO.10
            </div>
        </div>
        </div>
